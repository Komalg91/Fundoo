...
export default {
    ...
    methods: {
        ...
        toggle_none(){
            ...
            axios.post('http://localhost:3000/persons/notes/addnotes', notes_add).then(() => console.log("Success")).catch(() => console.log("Error"));
        }
    }
...
.take_title, .take_note, .toggle_btn{
    padding: 4px 16px 12px 16px;
}
