        ...
        <div class="main_right">
            <div class="display_container">
                <div class="display_notes_content">
                    <div class="display_notes" v-for="note in getdeleteNotes.slice().reverse()" :key="note._id">               
                        ...
                        <div class="toggle_btn_notes">
                            ...
                            <button @click="delete_btn(note)" class="delete_btn">
                            ...
                            <button class="color_btn">
                                ...
                                <div class="dropmenu">
                                    <span @click="redcolor(note)" :style="mystyle"></span>
                                    <span @click="greencolor" :style="mystyle2"></span>
                                </div>
                            </button>
...
<script type="module" src='./Displaydel.js'>

</script>


<style lang="scss">
@import '../Displayarchive/Displayarchive.scss';
