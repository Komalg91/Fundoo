<template>
    <div class="toggle_btn_notes">
        ...
        <button @click="archive_note_btn(this.note)" class="archieve_btn">
            <svg xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24" width="18px" fill="#000000"><path d="M0 0h24v24H0V0z" fill="none"/>
        ...
        <button @click="delete_note_btn(this.note)" class="delete_btn">
        ...
        <button class="color_btn">
            ...
            <div class="dropmenu">
                <div v-for="item in color_array" :key="item">
                    ...
                    <button :style="{backgroundColor: item.color}"  @click="changebg(item.color, this.note)"></button>
                </div>
            </div>
        </button>
...
<script type="module" src="./Notebuttons.js">
</script>
